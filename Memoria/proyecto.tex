...
\definecolor{codegreen}{rgb}{0.0,0.26,0.15}
\definecolor{codeapple}{rgb}{0.0,0.5,0.0}
\definecolor{codedartgreen}{rgb}{0.05, 0.5, 0.06}
...
\lstdefinestyle{Python}{
	...
	keywordstyle=\color{codegreen}\bfseries, %magenta
	numberstyle=\tiny\color{codegray},
	stringstyle=\color{codegreen}\bfseries, %codepurple
...
\lstdefinestyle{TypeScript}{
	keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, public, static, for, let, const},
	keywordstyle=\color{codegreen}\bfseries,
	ndkeywords={class, export, boolean, throw, implements, import, this, string, Buffer},
	ndkeywordstyle=\color{codeapple}\bfseries,
	identifierstyle=\color{black}\bfseries,
	basicstyle=\ttfamily\scriptsize,
	sensitive=false,
	comment=[l]{//},
	morecomment=[s]{/*}{*/},
	commentstyle=\color{codeperla}\ttfamily,
	stringstyle=\color{codedartgreen}\ttfamily,
	morestring=[b]',
	morestring=[b]",
...
% Ficheros con los contenidos
	...
	\input{capitulos/01_01_Conceptos}
