...
\begin{center}
{\large\bfseries Implementación de una blockchain resistente a ataques criptográficos post-cuánticos: Subtítulo del proyecto}\\
\end{center}
\begin{center}
...
\begin{center}
{\large\bfseries Implementation of a blockchain resistant to post-quantum cryptographic attacks: Project Subtitle}\\
\end{center}
\begin{center}
María Victoria Granados Pozo\\
\end{center}
...
D. \textbf{Francisco Javier Lobillo Borrero}, Profesor del Área de XXXX del Departamento YYYY de la Universidad de Granada.
...
Que el presente trabajo, titulado \textit{\textbf{ Implementación de una blockchain resistente a ataques criptográficos post-cuánticos, Subtítulo del proyecto}},
