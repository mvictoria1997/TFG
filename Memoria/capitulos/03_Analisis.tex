...
\begin{table}[H]
	...
	\begin{tabular}{p{0.14\linewidth} p{0.7\linewidth}}
		...
		RNF 1.5 & El programa deberá de ser compatible con cualquier sistema que tenga instalado \texttt{python}\\[0.5ex]
		RNF 1.6 & El proyecto deberá de contar con un manual de usuario claro y conciso\\[0.5ex]
		\bottomrule
	\end{tabular}}
	\end{center}
