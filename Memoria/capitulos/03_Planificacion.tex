...
\begin{table}[H]
	...
	\begin{tabular}{p{0.6\linewidth} p {0.15\linewidth}p{0.15\linewidth}}
		...
		Bloque de estudio\\
		\toprule
		Estudio tecnología \textit{blockchain} & 37 & 740\\[0.5ex]
		...
		Aritmética cuerpos finitos & 26 & 520\\[0.5ex]
...
Los costes indirectos corresponden a la electricidad y alquiler de la oficina como estos gastos no se pueden estimar correctamente se va a destinar un $10\%$ del total del proyecto. En este caso corresponde a $1.578,24$\euro \label{par:coste-ind}.\\


En los costes directos se van a meter los gatos en material de oficina, material informático y servicio de mantenimiento, véase la tabla \ref{tab:coste-di}. Este último incluye el precio de un nuevo disco de memoria interno, ya que ha sido necesario aumentar la memoria del portátil durante el desarrollo del proyecto.
...
Una vez que hemos calculado todos los gastos posibles, tabla \ref{tab:coste-total}, vamos a añadir un margen de contingencia del $5\%$ para posibles imprevistos del proyecto. Hemos obtenido que los gastos previstos serán de 16.537,64\euro, por tanto el margen de contingencia será de 868,03\euro, así el presupuesto final será de 18.228,67\euro\label{par:coste-impr}.
